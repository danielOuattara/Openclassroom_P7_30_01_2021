        ...
        <form name="form" @submit.prevent="addOnePhoto">
                ...
                <div class="form-group">
                    ...
                    <div 
                        ...
                        role="alert"> An image required to submit a new photo
                    </div>
                </div>
    ...
    methods: {
      ...
      async addOnePhoto() { // BACK UP: OK <<<<-----
          try {
              ...
              await axios.post( 'http://localhost:4200/api/photos', data, { headers: authHeader() }, config )
              this.loading = false;
